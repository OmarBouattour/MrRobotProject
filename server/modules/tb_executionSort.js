...
module.exports = class tb_executionSort {
    ...
    static fetchAll() {
        return db.execute('SELECT Execution_Id,CAST(Execution_Date AS CHAR(19)) AS Execution_Date,Execution_Desc,Execution_Total,Execution_Pass,Execution_Fail,Execution_Skip,cast(Execution_Time as decimal(10,1)) AS Execution_Time FROM `tb_execution` ORDER BY `tb_execution`.`Execution_Desc`        ');
      }
